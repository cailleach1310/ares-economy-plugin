module AresMUSH
  module Economy
    class EconomyLimitsTemplate < ErbTemplateRenderer
      
      attr_accessor :limits_chars
      
      def initialize(chars)
        self.limits_chars = chars
        super File.dirname(__FILE__) + "/limits.erb"
      end
      ...
      def chars_by_handle
        self.limits_chars.sort_by{ |c| c.name }
      end
